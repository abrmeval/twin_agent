...
def get_validator_instructions():
    return {
        ...
        "content": """
            ...
            - If the the user is GRETTING or ASKING for information that a recruiter would ask, return a JSON with a boolean variable called review_twin_response equals to True
