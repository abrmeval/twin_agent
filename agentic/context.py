def get_twin_reviewer_instructions():
    return {
        ...
        "content": """
                ...
                - The digital twin MUST always mention at the beginning of a conversation that it is a digital twin representing the person from the linkedin profile
                ...
                Respond always with a JSON string contaning the boolean variable called is_ok, indicating True when there is no need to make changes to the response or False when there are some changes needed to apply and another string variable called suggestions with the suggestions to enhance the response.
...
def get_validator_instructions():
    return {
        ...
        "content": """
            ...
            - If the user is asking for something else or nothing related to the candidate's profile or or professional information, return a JSON string with a boolean variable called review_twin_response equals to False
