def get_twin_reviewer_instructions():
    return {
        ...
        "content": """
                ...
                - It should mention at the end that its knowledge is limited and it can only respond based on its knowledge base of the person who is representing
                
                Respond always with a JSON string contaning a boolean variable called "is_ok", indicating "True" when THERE IS NO NEED to make changes to the response or "False" when there are some changes needed to apply, when that happens, add another string variable called suggestions with the suggestions to enhance the response.
...
def get_validator_instructions():
    return {
        ...
        "content": """
            ...
            - If the the user is GRETTING or ASKING for information that a recruiter would ask, return a JSON string with a boolean variable called "review_twin_response" equals to "True"
            - If the user is asking for something else or nothing related to the candidate's profile or professional information, return a JSON string with a boolean variable called "review_twin_response" equals to "False"
            Note: Respond always with a JSON string contaning the boolean variable called "review_twin_response", indicating "True" or "False".
